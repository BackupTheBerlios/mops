...
DownloadResults
CommonGetFileEx(DownloadsList &list,  double *itemnow, double *itemtotal, std::string *itemname, ActionBus *aaBus, ProgressData *prData)
{
	...
	return g_pCurrentMethod->getFile(list, itemnow, itemtotal, itemname); 
}	
